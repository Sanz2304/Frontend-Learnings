...
The XMLHttpRequest object is a built-in browser API that allows you to make HTTP requests to a server and handle the response asynchronously. 
It was the primary way to implement AJAX (Asynchronous JavaScript and XML) before the introduction of the Fetch API.


*/


// 1. Create an XHR object(Get Request)
...
While the Fetch API is the modern standard for making HTTP requests in JavaScript, XMLHttpRequest remains a powerful and widely supported tool. 
Understanding both APIs is essential for working across different environments and maintaining legacy systems.

For new projects, prefer the Fetch API for its simplicity and modern features. 
However, XHR is still valuable in specific scenarios where compatibility or fine-grained control is required.  
